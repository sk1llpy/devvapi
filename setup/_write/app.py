def _type(project_name: str, version: int, app_name: str):
    with open('/home/skilldev/Desktop/python_my_framework/setup/default/app/app.py', 'r') as app__file:
    ...
    with open('/home/skilldev/Desktop/python_my_framework/setup/default/app/views.py', 'r') as views__file:
